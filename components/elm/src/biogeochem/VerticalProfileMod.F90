  ...
  subroutine decomp_vertprofiles(bounds, &
    ...
    associate(                                                               & 
...
#if defined(TAM)
               froott_prof(p,1) = 1._r8/dzsoi_decomp(1)
               froota_prof(p,1) = 1._r8/dzsoi_decomp(1)
               frootm_prof(p,1) = 1._r8/dzsoi_decomp(1)
#else
      ...
      do fp = 1,num_soilp
         p = filter_soilp(fp)
#if defined(TAM)
         froott_prof_sum = 0._r8
         froota_prof_sum = 0._r8
         frootm_prof_sum = 0._r8
#else
